        ...
        if (userName.username == newUserName.setUserName && pinNumber.pin == newUserPassword.setUserPassword) {
            ...
            if (userOptions.operator == "Cash Withdraw") {
                ...
                if (bankDetails.bankoptions == "HBL") {
                    const amountToTransferHBL = await inquirer.prompt({
                        type: "number",
                        name: "accountbalance",
                    ...
                    const amountToTransferABL = await inquirer.prompt({
                        type: "number",
                        name: "accountbalance",
                        message: "How many Amount you want to transfer",
                        validate: (input) => {
                    ...
                    const amountToTransferMeezan = await inquirer.prompt({
                        type: "number",
                        name: "accountbalance",
                        message: "How many Amount you want to transfer",
                        validate: (input) => {
